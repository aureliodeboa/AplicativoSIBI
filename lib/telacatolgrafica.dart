              ...
              child: 
                Column(
                  children: [
                    ...
                    Text(
                        " Conhecida como ficha catalográfica. É o registro das informações que"
                    ...
                    Text(
                      "OBS.: PARA TRABALHOS EM FORMATO DE ARTIGO NÃO SERÃO ELABORADAS AS FICHAS CATALOGRÁFICAS."),
                        ...
                        TextButton.icon(
                          ...
                          label: 
                            Text(
                              ' MODELO DA FICHA CATALOGRÁFICA E ORIENTAÇÕES',
                              style: TextStyle(color: Colors.black)),
                              onPressed: () => setState(() {
